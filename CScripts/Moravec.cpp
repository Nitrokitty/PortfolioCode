...
int main(int argc, char *argv[])
{
	...
	char *cTemp = new char[10];
        ...
        snprintf(fileName, 50*sizeof(char), "%s", argv[1]);    //changing the data type of the file name of the input array to a string
...
//	cout << "Looping\n";
	...
	ofstream timeFile("time.txt", ios_base::app);
